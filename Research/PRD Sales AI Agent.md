...
| US-4 | As a visitor, I want to fill in a contact form with my questions so the sales team can reach me | Contact form is presented in chat when there is a gap in the agent’s knowledge/user rejects to book a meeting. Form captures name, email, company, message. |
...
| **ID** | **User Story** | **Acceptance Criteria** |
| --- | --- | --- |
| US-8 | As a sales manager, I want qualified leads delivered to HubSpot/Calendly so I can follow up quickly | Leads from agent conversations appear in HubSpot/Calendly with qualification data, contact info, and conversation context. |
...
When the users asks something outsides agent’s knowledge OR rejects to book a meeting, the agent presents an in-chat contact form. Form fields:

| **Field** | **Required** | **Notes** |
| --- | --- | --- |
| Full Name | **✓** | Free text |
| Email | **✓** | Validated format |
| Company | **✓** | Free text. Pre-filled if collected during conversation. |
| Message / Notes | - | Optional. Pre-filled with conversation summary/question from the user if available. |
...
| --- | --- | --- | --- |
| visitor_id | String | Yes, Auto | Auto-generated from Botpress built-in userId. Persisted via browser cookie. Used to identify returning visitors. |
...
Engage with off-topic or inappropriate requests | Fixed timelines without discovery
...
└─ Hot lead    →  Calendly link → Calendly syncs to HubSpot

└─ Warm lead   →  Calendly link → Calendly syncs to HubSpot
